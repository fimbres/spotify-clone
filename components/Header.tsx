...
const Header: React.FC<HeaderProps> = ({ children, className, bgColor }) => {
  ...
  return (
    <div className={`h-fit p-6 ${className} ${bgColor ? bgColor : 'bg-gradient-to-b from-emerald-800 to-transparent'}`}>
